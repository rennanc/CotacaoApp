...
CREATE TABLE IF NOT EXISTS `corretorBD`.`Condutor` (
  ...
  `IE_TIPO` VARCHAR(2) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `corretorBD`.`Seguradora` (
  ...
  `DS_RECEPCAO` VARCHAR(250) NULL COMMENT '',
  `DS_PRODUCAO` VARCHAR(250) NULL COMMENT '',
  `DS_ASS24H` VARCHAR(250) NULL COMMENT '',
  `DS_OUTROS` VARCHAR(250) NULL COMMENT '',
  `VL_CALCULOS` DECIMAL NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `corretorBD`.`Cobertura` (
  ...
  `DT_DATAHORA_SINISTRO` DATETIME NULL COMMENT '',
  `DS_LOCAL_SINISTRO` VARCHAR(45) NULL COMMENT '',
  `DS_SINISTRO` VARCHAR(500) NULL COMMENT '',
  `SG_SITUACAO_SINISTRO` VARCHAR(45) NULL COMMENT '',
  `DS_OBSERVACAO_SINISTRO` VARCHAR(500) NULL COMMENT '',
